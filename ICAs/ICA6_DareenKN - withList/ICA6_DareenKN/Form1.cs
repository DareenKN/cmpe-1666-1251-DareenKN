...
namespace ICA6_DareenKN
{
    public partial class Form1 : Form
    {
        ...
        private List<Card> cardDeck = new List<Card>(); // Using a list to store the deck of cards        
        private Card[,] playerHands = new Card[10, 5];  // Card deck as a 2D array
        ...
        public Form1()
        {
            ...
            {
                for (int rankNum = 2; rankNum <= 14; rankNum++)
                    cardDeck.Add(CreateCard((Suit)suitType, rankNum));
            }            
        }
        ...
        private void ShuffleCards(List<Card> deck)
        {
            ...
            {
                int j = rand.Next(0, i + 1);
                (deck[i], deck[j]) = (deck[j], deck[i]); // C# tuple swap
            }
        }
        ...
        /// <param name="deck"></param>
        /// <param name="playerHands"></param>
        private void DealHands(List<Card> deck, Card[,] playerHands)
        {
            Array.Clear(playerPoints, 0, playerPoints.Length);
            ...
            for (int round = 0; round < 5; round++)
            {
                for (int player = 0; player < 10; player++)
                {
                    playerHands[player, round] = deck[cardIndex++];
                    playerPoints[player] += playerHands[player, round]._points;
                }
            }
        }
        ...
        private void UI_LoadCards_Btn_Click(object sender, EventArgs e)
        {
            ...
            foreach (var card in cardDeck)
                UI_StartingDeck_Lbx.Items.Add(CardToString(card));
        }
        ...
        private void UI_ShuffleCards_Btn_Click(object sender, EventArgs e)
        {
            ...
            // Display shuffled cards
            foreach (var card in cardDeck)
                UI_ShuffledDeck_Lbx.Items.Add(CardToString(card));
        }
        ...
        private void UI_DealHands_Btn_Click(object sender, EventArgs e)
        {
            ...
            DealHands(cardDeck, playerHands);
